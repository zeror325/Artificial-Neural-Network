...
for x in range(1000):
    ...
    mse.append(instant_mse)         #ITERASYONU DURDURMA KRITERI
    if (np.abs(mse[-1]-mse[len(mse)-2]) <= 0.00000000001) or (mse[-1] <= 0.0005):
        break

#EGITIM KUMESI VE ILGILI BILLINGS DURUMLARI CIZDIRILIYOR
fig1 = plt.figure()
ax1 = fig1.add_subplot(111)
training_plot1 = ax1.plot(training_yd,'g',label = 'Billings Sistemi')
