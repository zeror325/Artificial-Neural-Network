...
#LINEER AYRISTIRILABILIRLIGINDEN EMIN OLMAK ICIN 5. BOYUTTAKI DEGERLERIN ARALIKLARINI ZIT SECIYORUZ
#AR = np.random.randint(-10,10, size = (20,4))   
#BR = np.random.randint(-10,10, size = (20,4))   
#AR2 = np.random.randint(1,5, size = (20,1))     
#BR2 = np.random.randint(-5,-1, size = (20,1))
#print("AR = \n",AR,"\n")
#print("AR2 = \n",AR2,"\n")

#A = np.concatenate((AR,AR2), axis = 1)              #ilk grup
#B = np.concatenate((BR,BR2), axis = 1)              #ikinci grup
#print("A = \n",A,"\n")
#print("B = \n",B,"\n")
...
while True:
    ...
    for x in range(np.shape(E)[0]):
        ...
        print("W = \n",W,"\n")
    print("W_eski - W = \n",(W_eski - W),"\n")
    if np.array_equal((W_eski - W),np.array(np.zeros(6),dtype = int)):
        break
